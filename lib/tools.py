...
def Langchain_interview_question(prompt):
    ...
    partial_variables={"format_instructions": f"""면접 시작시에는 "{user_info["면접을 볼 회사"]}에 대한 면접을 시작합니다."로 시작하세요. 질문 시에는 사용자 정보와 대답에 따라 유동적인 질문을 하세요. 면접이 끝난 이후에는 "{user_info["면접을 볼 회사"]}에 대한 면접을 종료합니다."라는 말로 끝맺으세요"""}
    )
